                ...
                <form action="<?php echo base_url(); ?>index.php/Leads/importdata" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <button type="submit" class="btn btn-success" name="submit" value="submit">Upload
                                    Excel/CSV File Here</button>
                            </div>
                    ...
                    <div class="row" id="filter_hide">
					  ...
					  if ($employees): ?>
                        ...
                        <div class="col-md-4 col-sm-4">
                            ...
                            <input type="text"
                                value="<?php if(!empty($filtered_value['from_date'])) { echo date('d-m-Y',strtotime($filtered_value['upto_date']));} ?>"
                ...
                <form method="get" action="<?php echo base_url(); ?>index.php/Leads/approveall">
                    <div class="col-md-6" style="margin-left:-1%; ">
                        ...
                        <div class="col-md-3 col-sm-3" style="margin-top:-55px;margin-left:60%;">
                            <button type="submit" class="btn transparent_button bulk_action"
						...
						if($obj['is_duplicate']== 0){ ?>
							...
							// print_r($leads_id);
							 ...
							 ?>
                                    ...
                                    <?php 
									if($obj['lead_status'] == 'Qualify'){
										$btn_class='btn-pending';

									}else if($obj['lead_status'] == 'Won'){
										$btn_class='btn-approved';

									}else if($obj['lead_status'] == 'Loss'){
