...
<head>
    ...
    <title> Saral Lead ERP - Admin Panel </title>
            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    <div class="wd-50 bg-white p-2 rounded-circle shadow-lg position-absolute translate-middle top-0 start-50">
                        <img src="<?= base_url('uploads/mo.png') ?>" alt="" class="img-fluid">
                    </div>
                    <div class="card-body p-sm-5">
                        ...
                        <form action="<?php echo base_url() ;?>index.php/User_authentication/user_login_process"
                            method="post" class="w-100 mt-4 pt-2">
                            <div class="mb-4">
                                <input type="text" class="form-control"
                                    placeholder="<?= $this->lang->line('Username/email') ?>" value="" name="username"
                                    required>
                            </div>
                            <div class="mb-3">
                                <input type="password" name="password" class="form-control"
                                    placeholder="<?= $this->lang->line('Password') ?>" value="" required>
                            </div>
                                ...
                                <div>
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label c-pointer"
                                            for="rememberMe"><?= $this->lang->line('remember_me') ?></label>
                                    </div>
                                </div>
                                <div>
                                    <a href="<?= base_url('index.php/User_authentication/ForgotPassword') ?>"
                                        class="fs-11 text-primary"><?= $this->lang->line('forgot_password') ?></a>
                                </div>
                            </div>
                            <div class="mt-5">
                                <button type="submit"
                                    class="btn btn-lg btn-primary w-100"><?= $this->lang->line('login') ?></button>
                            </div>
                        </form>
                        <div class="w-100 mt-5 text-center mx-auto">
                            ...
                            <div class="d-flex align-items-center justify-content-center gap-2">
                                <a href="javascript:void(0);" class="btn btn-light-brand flex-fill"
                                    ...
                                    title="<?= $this->lang->line('loginwithfacebook') ?>">
                                    <i class="feather-facebook"></i>
                                </a>
                                <a href="javascript:void(0);" class="btn btn-light-brand flex-fill"
                                    data-bs-toggle="tooltip" data-bs-trigger="hover"
                                    title="<?= $this->lang->line('loginwithgmail') ?>">
                        ...
                        <div class="mt-2 text-muted">
                            ...
                            <a href="auth-register-minimal.html" class="fw-bold">
                                <?= $this->lang->line('Create_an_Account') ?></a>
                        </div>
                        <div class="mt-2 text-muted">
                            <label>Language Change :</label>
                            <select class="form-control" onchange="location = this.value;" style="width: 50%;">
                                <option value="<?= site_url('AdminController/change_language/english') ?>"
                                    <?= ($language_label == 'English') ? 'selected' : '' ?>>English</option>
                                <option value="<?= site_url('AdminController/change_language/hindi') ?>"
                                    <?= ($language_label == 'Hindi') ? 'selected' : '' ?>>Hindi</option>
                            </select>
                        </div>
                    </div>
                </div>
