            ...
            <div class="card-body">
                <form id="salaryForm">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label class="control-label fw-semibold"><?= $this->lang->line('select_month') ?> hyy</label>
                        ...
                        <div class="col-md-4">
                            <label class="control-label fw-semibold"><?= $this->lang->line('select_employee') ?></label>
                            <?php echo form_dropdown('emp_id', $employees, '', 'id="emp_id" required="required" class="form-control"'); ?>
                        </div>

                        <div class="col-md-4">
                            <label class="control-label fw-semibold"> </label>
