                     ...
                     <li class="d-flex justify-content-between feed-item feed-item-success">
                         <div>
                             ...
                             <div class="d-flex align-items-center">
                                 <a href="javascript:void(0)" class="me-2"> Ticket Created
                                     <?= $obj['ticket_data']['ticket'] ?></a>
                                 <div class="fs-11 fw-normal text-muted">(<?= $obj['ticket_data']['created_at'] ?>)
                                 </div>
                             </div>
                             <div class="fs-12 text-muted mt-1 text-truncate-2-line">
                                 <?= $obj['ticket_data']['description'] ?></div>
                         </div>
                     </li>
                     <li class="d-flex justify-content-between feed-item feed-item-info">
                         <div>
                             <span class="text-truncate-1-line lead_date">5+ friends join this group <span
                                     class="date">[April 20, 2023]</span></span>
                             <span class="text">Joined the group <a href="javascript:void(0);"
             ...
             <div class="p-4">
                 ...
                 <div class="mb-4 d-flex align-items-start">
                     ...
                     <div>
                         ...
                         <div class="fs-12 text-muted mt-1 text-truncate-2-line">Lorem ipsum dolor sit amet, consec
                             tetuer adipi scing elit aenean commodo scing elit aenean commodo</div>
                     </div>
                 </div>
                 <div class="mb-4 d-flex align-items-start">
                     <div>
