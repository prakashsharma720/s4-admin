    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5> <a
                        href="<?php echo base_url('index.php/Employees/index'); ?>"><?= $this->lang->line('employee') ?></a>
                </h5>
            </div>
            <ul class="breadcrumb">
            ...
            <div class="card-body">
                <div class="row">
                            ...
                            <table class="table table-hover  table-bordered table-striped" id="proposalList">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="white-space: nowrap;width: 20%;"> <?= $this->lang->line('action') ?>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    foreach ($employees as $obj) { ?>
                                        <tr>
                                            <td><input type="checkbox" class="sub_chk" value="<?php echo $obj['id']; ?>" />
                                            </td>
                                ...
                                <?php else: ?>
                                    <div class="w-100 text-center">
                                        <img src="<?= base_url('assets/images/avatar/1.png'); ?>" 
                                            class="rounded mx-auto d-block" 
                                            style="width: 100px; height: 80px; object-fit: cover;" 
                                            alt="Default Avatar">
                                    </div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <a href="javascript:void(0);" data-bs-toggle="offcanvas"
                                                        data-bs-target="#deleteEmployees<?= $obj['id']; ?>"
                                                    ...
                                                    <div class="modal-content" style="width:800px !important">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">
                                                                <?= $this->lang->line('employee_detail') ?></h4>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <fieldset>
                                                                    <legend><?= $this->lang->line('personal_details') ?>
                                                                    </legend>
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="name"><?= $this->lang->line('name') ?>
                                                                                :</label>
                                                                            <span><?php echo $obj['name']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="email"><?= $this->lang->line('email') ?>:</label>
                                                                            <span><?php echo $obj['email']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="dob"><?= $this->lang->line('mobile_no') ?>:</label>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="name"><?= $this->lang->line('role') ?>
                                                                                :</label>
                                                                            <span><?php echo $obj['role']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="email"><?= $this->lang->line('department') ?>:</label>
                                                                            <span><?php echo $obj['department_name']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="dob"><?= $this->lang->line('designation') ?>:</label>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="name"><?= $this->lang->line('date_of_joining') ?>
                                                                                :</label>
                                                                            <span><?php echo $obj['date_of_joining']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="email"><?= $this->lang->line('authority_person') ?>:</label>
                                                                            <span><?php echo $obj['author_email']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="dob"><?= $this->lang->line('date_of_birth') ?>:</label>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="name"><?= $this->lang->line('aadhaar_no') ?>
                                                                                :</label>
                                                                            <span><?php echo $obj['aadhaar_no']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="email"><?= $this->lang->line('pan_no') ?>:</label>
                                                                            <span><?php echo $obj['pan_no']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="dob"><?= $this->lang->line('address') ?>:</label>
                                                                ...
                                                                <fieldset>
                                                                    <legend><?= $this->lang->line('bank_details') ?>
                                                                    </legend>
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="name"><?= $this->lang->line('account_holder_name') ?>
                                                                                : </label>
                                                                            <span><?php echo $obj['account_holder_name']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="email"><?= $this->lang->line('bank_name') ?>
                                                                                :</label>
                                                                            <span><?php echo $obj['bank_name']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="dob"><?= $this->lang->line('account_number') ?>
                                                                                :</label>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="name"><?= $this->lang->line('ifsc_code') ?>
                                                                                : </label>
                                                                            <span><?php echo $obj['ifsc_code']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="email"><?= $this->lang->line('branch_name') ?>
                                                                                :</label>
                                                                            <span><?php echo $obj['branch_name']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="dob"><?= $this->lang->line('account_type') ?>
                                                                                :</label>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="name"><?= $this->lang->line('upi_id') ?>:
                                                                            </label>
                                                                ...
                                                                <fieldset>
                                                                    <legend><?= $this->lang->line('salary_details') ?>
                                                                    </legend>
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="name"><?= $this->lang->line('salary_details') ?>:</label>
                                                                            <span><?php echo $obj['salary']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="email"><?= $this->lang->line('hra') ?>
                                                                                :</label>
                                                                            <span><?php echo $obj['hra']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="dob"><?= $this->lang->line('conveyance_allowance') ?>
                                                                                :</label>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label for="name">
                                                                                <?= $this->lang->line('medical_allowance') ?>:
                                                                            </label>
                                                                            <span><?php echo $obj['m_allowance']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="email"><?= $this->lang->line('other_allowance') ?>
                                                                                :</label>
                                                                            <span><?php echo $obj['o_allowance']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="dob"><?= $this->lang->line('total_net_salary') ?>
                                                                                :</label>
                                                                ...
                                                                <fieldset>
                                                                    <legend><?= $this->lang->line('other_details') ?>
                                                                    </legend>
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="name"><?= $this->lang->line('emergency_mobile_no') ?>
                                                                                : </label>
                                                                            <span><?php echo $obj['emobile_no']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="email"><?= $this->lang->line('emergency_name') ?>
                                                                                :</label>
                                                                            <span><?php echo $obj['ename']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="dob"><?= $this->lang->line('uan_no') ?>
                                                                                :</label>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="name"><?= $this->lang->line('pf_no') ?>
                                                                                : </label>
                                                                            <span><?php echo $obj['pf']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="email"><?= $this->lang->line('esi_no') ?>
                                                                                :</label>
                                                                            <span><?php echo $obj['esi']; ?></span>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <label
                                                                                for="dob"><?= $this->lang->line('username') ?>
                                                                                :</label>
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="deleteEmployees<?= $obj['id']; ?>">
                        <form method="post"
                            action="<?= base_url('index.php/Employees/deleteEmployee/' . $obj['id']); ?>">
                            ...
                            <!-- Footer Buttons -->
                            <div
                                class="px-4 gap-2 d-flex align-items-center justify-content-between ht-80 border-top border-gray-2">
