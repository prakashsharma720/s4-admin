            ...
            <form method="get">
                <div class="row" id="filter_hide">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <input type="text" value="<?php if (!empty($filtered_value['from_date'])) {
								echo date('d-m-Y', strtotime($filtered_value['from_date']));
							} ?>" data-date-formate="dd-mm-yyyy" name="from_date" class="form-control date-picker" placeholder="dd-mm-yyyy"
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <input type="text" value="<?php if (!empty($filtered_value['from_date'])) {
							...
							} ?>" data-date-formate="dd-mm-yyyy" name="upto_date" class="form-control date-picker" placeholder="dd-mm-yyyy"
                            autocomplete="off" autocomplete="off">
                    </div>
