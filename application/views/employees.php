                    ...
                    <div class="tab-content">
                        <div class="tab-pane active show" id="activity">
                            <div class="form-group">
                                <div class="row col-md-12">
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"><?= $this->lang->line('name') ?><span class="">*</span></label>
                                        <input type="text" placeholder="<?= $this->lang->line('enter_employee_name') ?>" name="name"
                                            class="form-control"  autofocus>
                                    </div>
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"> <?= $this->lang->line('code') ?> <span class="">*</span></label>
                                    ...
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"> <?= $this->lang->line('email') ?> <span class="">*</span></label>
                                        <input type="text" placeholder="<?= $this->lang->line('enter_email') ?>" name="email"
                                            class="form-control email" value=""  autofocus>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row col-md-12">
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"><?= $this->lang->line('select_role') ?><span class="">*</span></label>
                                        <?php  echo form_dropdown('role_id', $roles, '', '=""')
						            	?>
                                    </div>
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"> <?= $this->lang->line('mobile_no') ?> <span class="">*</span></label>
                                    ...
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"> <?= $this->lang->line('select_department') ?> <span class="">*</span></label>
                                        <?php  
                                    ...
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"> <?= $this->lang->line('username') ?> <span class="">*</span> </label>
                            ...
                            <div class="form-group">
                                <div class="row col-md-12">
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"> <?= $this->lang->line('password') ?> <span class="">*</span></label>
                                    ...
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"> <?= $this->lang->line('gender') ?> <span class="">*</span></label>
                                    ...
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"> <?= $this->lang->line('address') ?> <span class=""> *</span></label>
                                        <textarea class="form-control address" rows="3" placeholder=" <?= $this->lang->line('enter_address') ?>"
                                            name="address" value="" s></textarea>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row col-md-12">
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"> <?= $this->lang->line('aadhaar_no') ?> <span class="">*</span></label>
                        ...
                        <div class="tab-pane" id="timeline">
                            <div class="form-group">
                                <div class="row col-md-12">
                                    ...
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"><?= $this->lang->line('bank_name') ?><span class="">*</span></label>
                            ...
                            <div class="form-group">
                                <div class="row col-md-12">
                                    ...
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"><?= $this->lang->line('ifsc_code') ?><span class="">*</span></label>
                                        <input type="text" name="ifsc_code" class="form-control " value=""
                                            placeholder="<?= $this->lang->line('ifsc_code') ?>" autofocus>

                                    </div>
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"><?= $this->lang->line('branch_name') ?><span class="">*</span></label>
                                        <input type="text" name="branch_name" class="form-control" value=""
                                            placeholder="<?= $this->lang->line('branch_name') ?>" autofocus>

                                    </div>
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"><?= $this->lang->line('account_type') ?><span class="">*</span></label>
                        ...
                        <div class="tab-pane" id="salary">
                            <div class="form-group">
                                <div class="row col-md-12">
                                    <div class="col-md-4 col-sm-4 ">
                                        <label class="control-label"><?= $this->lang->line('basic_salary') ?><span class="">*</span></label>
