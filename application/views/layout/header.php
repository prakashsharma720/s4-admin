...
$selected_lang = array_filter($languages, function($l) use ($selected_lang_code) {
    return strtolower($l['code']) === $selected_lang_code;
});
    ...
    <div class="header-wrapper">
        ...
        <div class="header-left d-flex align-items-center gap-4">
            ...
            <div class="nxl-drp-link nxl-lavel-mega-menu">
                <div class="nxl-lavel-mega-menu-toggle d-flex d-lg-none">
                    <a href="javascript:void(0)" id="nxl-lavel-mega-menu-hide"><i
                            class="feather-arrow-left me-2"></i><span>Back</span></a>
                </div>
        ...
        <div class="header-right ms-auto">
            <div class="d-flex align-items-center">
                <div class="dropdown nxl-h-item nxl-header-language d-none d-sm-flex">
                    <a href="javascript:void(0);" class="nxl-head-link me-0" data-bs-toggle="dropdown">
                        <div class="avatar-image avatar-sm">
                            <img src="<?= base_url("assets/vendors/img/flags/1x1/" . ($selected_lang_code === 'bulg' ? 'bg' : ($selected_lang_code === 'hindi' ? 'in' : 'us')) . ".svg") ?>"
                                class="img-fluid wd-20" alt="Lang" />
                        </div>
                        <!-- &nbsp;<span><?= $selected_lang_code ?></span> -->
                    </a>
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-language-dropdown"
                        data-bs-auto-close="outside" style="margin-top:-20px;">
                        <div class="language-items-wrapper">
                            <div class="select-language px-4 py-2 hstack justify-content-between gap-4">
                                ...
                                <a href="javascript:void(0);" class="avatar-text avatar-md" title="Add Language"><i
                            ...
                            <div class="row px-4 pt-3">
                                ...
                                <div
                                    class="col-sm-4 col-6 language_select <?= strtolower($selected_lang_code) == strtolower($lang['code']) ? 'active' : '' ?>">
                                    <a href="<?= site_url('AdminController/change_language/') . $lang['code'] ?>"
                                        class="d-flex align-items-center gap-2">
                                        <div class="avatar-image avatar-sm">
                                            <img src="<?= base_url("assets/vendors/img/flags/1x1/{$lang['flag']}.svg") ?>"
                                                class="img-fluid" alt="<?= $lang['name'] ?>" />
                                        </div>
                                        <span><?= $lang['name'] ?></span>
                                    </a>
                                </div>
                ...
                <div class="dropdown nxl-h-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                        ...
                        <div class="notifications-scrollable" style="max-height: 300px; overflow-y: auto;">
                            ...
                            <div class="notifications-item">
                                ...
                                <div class="notifications-desc">
                                    <a href="<?= base_url('index.php/' . $notification['page_url']) ?>"
                                        class="font-body text-truncate-2-line">
                                        <!-- <span
                                            class="fw-semibold text-dark"><?= $isEmp ? 'You' : htmlspecialchars($notification['creator']) ?></span>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="notifications-date text-muted border-bottom border-bottom-dashed">
                                            <?= time_Ago(strtotime($notification['datetime'])) ?></div>
                                        <div class="d-flex gap-2">
                                            <a href="javascript:void(0);"
                                                class="d-block wd-8 ht-8 rounded-circle bg-gray-300"
                                                title="Mark as Read"></a>
                                            <a href="javascript:void(0);" class="text-danger" title="Remove"><i
                                                    class="feather-x fs-12"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="text-center notifications-footer">
                            <a href="<?= base_url('index.php/Notifications/index') ?>"
                                class="fs-13 fw-semibold text-dark"><?= $this->lang->line('all_notifications') ?></a>
                        </div>
                    </div>
                </div>
                ...
                <!-- User Profile -->
                <div class="dropdown nxl-h-item">
                    <a href="javascript:void(0);" data-bs-toggle="dropdown"><img src="<?= get_avatar_url($photo) ?>"
                            class="img-fluid user-avtar me-0" alt="user" /></a>
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header d-flex align-items-center">
                            <img src="<?= get_avatar_url($photo) ?>" class="img-fluid user-avtar" alt="user" />
                            <div>
                                <h6 class="text-dark mb-0">
                                    <?= strlen($name) > 8 ? substr($name, 0, 8) . '...' : $name ?><span
                                        class="badge bg-soft-success text-success ms-1">PRO</span></h6>
                                <span class="fs-12 text-muted"><?= $email ?></span>
                            </div>
                        </div>
                        <a href="<?= base_url('index.php/User_authentication/MyPasswordChangeView') ?>"
                            class="dropdown-item"><i
                                class="feather-settings"></i><span><?= $this->lang->line('account_setting') ?></span></a>
                        <a href="<?= base_url('index.php/Notifications/index') ?>" class="dropdown-item"><i
                                class="feather-bell"></i><span><?= $this->lang->line('notification') ?></span></a>
                        <div class="dropdown-divider"></div>
                        <a href="<?= base_url('index.php/User_authentication/logout') ?>" class="dropdown-item"><i
                                class="feather-log-out"></i><span><?= $this->lang->line('logout') ?></span></a>
                    </div>
                </div>
