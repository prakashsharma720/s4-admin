...
public function employeesList($conditions = null) 
{
    ...
    if (!empty($conditions['employee_id'])) {
        $this->db->where('employees.id', $conditions['employee_id']);
    }
	if (!empty($conditions['department_id'])) {
        $this->db->where('employees.department_id', $conditions['department_id']);
    }
	...
	public function getById($id) {
       $this->db->select('employees.*,roles.role,designations.designation,departments.department_name');
		$this->db->from('employees');
		$this->db->join('roles', 'employees.role_id = roles.id', 'left');
		        $this->db->join('designations', 'employees.designation_id = designations.id', 'left');
