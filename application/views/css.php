<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url()."assets/"; ?>plugins/font-awesome/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()."assets/"; ?>vendors/css/jquery-jvectormap.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()."assets/"; ?>vendors/css/select2.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()."assets/"; ?>vendors/css/select2-theme.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()."assets/"; ?>vendors/css/jquery.time-to.min.css">
