            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    ...
                    <div class="card-body p-sm-5">
                        ...
                        <form action="<?php echo base_url() ;?>index.php/User_authentication/EmailVerify"
                        ...
                        <div class="mt-5 text-muted">
                            ...
                            <?php echo anchor('User_authentication/index', 'Login Page', 'title="Back to login Page" style="color:#8cd2a1;font-weight:500;" class="fw-bold"') ?>
